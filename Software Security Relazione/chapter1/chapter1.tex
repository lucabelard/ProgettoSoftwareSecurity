...
\subsection{Scenario As-Is: Supply Chain Tradizionale}
...
\subsection{Scenario To-Be: Introduzione del Sistema Blockchain}
...
\begin{figure}[ht!]
    ...
    \caption{Modello SR: Supply Chain To-Be (Con Smart Contract)}
    \label{fig:sr_to_be}
\end{figure}
